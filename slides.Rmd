...
- related packages: **microbenchmark**, **rbenchmark**, **benchmark**, ...

```{r rowsum-benchmark, cache = TRUE}
...
- See more at [CRAN task view][cran-task-view-hpc] on high-performance and
  parallel computing.
...
- Wickham, H. (2014). [*Advanced R*][adv-r-book]. CRC Press.
...
[adv-r-book]: http://adv-r.had.co.nz
